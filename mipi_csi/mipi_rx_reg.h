...
/* Define the union U_ALIGN_INT_MASK */
typedef union {
    /* Define the struct bits */
    struct {
...
typedef struct {
    ...
    volatile LvdsSyncCodeCfgTag lvds_this_frame_sync_code[16]; /* 0x1320~0x151c, 16 index */
    volatile LvdsSyncCodeCfgTag lvds_next_frame_sync_code[16]; /* 0x1520~0x171c, 16 index */
...
typedef struct {
    MipiCtrlRegsTag mipiCtrlRegs; /* 0x1004 ~ 0x12fc */
    LvdsCtrlRegsTag lvdsCtrlRegs; /* 0x1300 ~ 0x1ffc */
} MipiRxCtrlRegsTag;

/* ============================================================================== */
/* Define the global struct */
typedef struct {
    MipiRxPhyCfgTag mipiRxPhyCfg[1]; /* 0x0 ~ 0x1fc */
    volatile unsigned int reserved_0[384]; /* 0x200 ~ 0x7fc, 384 index */
    MipiRxSysRegsTag mipiRxSysRegs; /* 0x800 ~ 0xffc */
    MipiRxCtrlRegsTag mipiRxCtrlRegs[2]; /* 0x1000 ~ 0x1ffc, 2 index */
} MipiRxRegsTypeTag;
